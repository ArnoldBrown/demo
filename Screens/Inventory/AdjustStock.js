...
export default function AdjustStock({navigation}) {
      ...
      {findDevicetype.isTab === 'Tablet' ? (
        <View>
          <View
            ...
            <View
              ...
              <Text style={global.headTitle}>Adjust stock Documents</Text>
            </View>
          ...
          <View style={styles.stockDateSection}>
            ...
            <Text style={styles.stockDate}>Document Type</Text>
        ...
        <View style={{flex: 1}}>
          <View style={styles.inventoryMobileHaeder}>
            ...
            <Text style={styles.headerName}>Adjust Stock Documnet</Text>
          ...
          <View style={styles.documentSection}>
            ...
            <Text style={styles.documentTotal}>Document Type</Text>
          </View>
