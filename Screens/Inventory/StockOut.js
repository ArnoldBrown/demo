...
export default function StockOut({navigation}) {
      ...
      <View>
        <View
          ...
          <View
            ...
            <Text style={global.headTitle}> Stock-Out Documents</Text>
          </View>
        ...
        <View style={styles.stockDateSection}>
          ...
          <Text style={styles.stockDate}>Ref Doc No.</Text>
        ...
        <View style={{flex: 1}}>
          <View style={styles.inventoryMobileHaeder}>
            ...
            <Text style={styles.headerName}>Stock-Out Documnet</Text>
