...
export default function CheckStock({navigation}) {
      ...
      {findDevicetype.isTab === 'Tablet' ? (
        <View>
          <View
            ...
            <View
              ...
              <Text style={global.headTitle}>Check stock Documents</Text>
            </View>
          ...
          <View style={styles.stockDateSection}>
            ...
            <Text style={styles.stockDate}>Document Name</Text>
        ...
        <View style={{flex: 1}}>
          <View style={styles.inventoryMobileHaeder}>
            ...
            <Text style={styles.headerName}>Check Stock Documnet</Text>
          ...
          <View style={styles.documentSection}>
            ...
            <Text style={styles.documentTotal}>Document Name</Text>
          </View>
