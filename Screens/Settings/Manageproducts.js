    ...
    <Text style={global.btnText1}>Show on selling screen</Text>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Image
                  source={require('../../Images/edits.png')}
            ...
            return (
              <View style={{width: 150, right: 0, flexDirection: 'row'}}>
                <TouchableOpacity
                  ...
                  />
                     <Text style={{color:'white',paddingTop:9}}>Edit</Text>
                </TouchableOpacity>
    ...
    <SafeAreaView style={global.commonBg}>
      ...
      {findDevicetype.isTab !== 'Tablet' ? (
        <View style={[global.commonHeader, {padding: 15}]}>
          ...
          <Text style={global.headTitle}>Manage Products</Text>
        ...
        <View style={global.tabHeader}>
          <View style={global.tabHeadcol1}>
            ...
            <Text style={global.headTitle}>Product Management</Text>
          ...
          <View style={global.tabHeadcol2}>
            <View style={global.commonFlexrow_bt}>
              ...
              <View style={global.flexRowsec}>
                <Text style={[global.headSvbtn, {marginHorizontal: 11}]}>
                  Edit
                </Text>

                <Text style={global.headSvbtn}>Add Product</Text>
              </View>
            </View>
          </View>
        </View>
